                  ...
                  <form>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      <div>
                        ...
                        <input
                          ...
                          placeholder={
                            vehicleType === "car"
                              ? "e.g., Toyota Camry 2.5 XLE"
                              : "e.g., Honda CBR650R ABS"
                          }
                          required
                        />
                      </div>
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-gray-500 text-sm mt-1">
                        Minimum 50 characters. Be detailed and honest about the
                        vehicle's condition.
                      </p>
                    </div>
              ...
              {step === 3 && (
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Add clear, high-quality photos of your vehicle. Listings
                    with good photos sell faster!
                  </p>
                  ...
                  {photos.length > 0 && (
                    <div className="mb-6">
                      <h3 className="font-medium mb-3">
                        Uploaded Photos ({photos.length}/12)
                      </h3>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      <strong>Photo tips:</strong> Include exterior (all sides),
                      interior, dashboard, and engine bay. Make sure your photos
                      are well-lit and clearly show the condition of your
                      vehicle.
                    </div>
                  </div>
                    ...
                    {!title ? (
                      <>
                        ...
                        <div className="text-sm text-red-800">
                          <strong>Looking bad!</strong> Your listing is not
                          ready to be published. please check the details and
                      ...
                      <>
                        ...
                        <div className="text-sm text-green-800">
                          <strong>Looking good!</strong> Your listing is ready
                          to be published. Once submitted, it will be reviewed
                          and should go live within 24 hours.
                        </div>
                      </>
                    )}
                  </div>
