...
import { Menu, X, ChevronDown, LogIn, User, Car, Heart, Bell, PlusCircle } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/vehicles" className="font-medium text-gray-700 hover:text-blue-600 transition-colors">
              Browse
            </Link>
            ...
            <Link href="/sell" className="font-medium text-gray-700 hover:text-blue-600 transition-colors">
              Sell
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            {!isLoggedIn ? (
              ...
              <>
                <Link href="/dashboard/favorites" className="p-2 rounded-full hover:bg-gray-100">
                  <Heart size={22} className="text-gray-700" />
                </Link>
                <Link href="/dashboard/notifications" className="p-2 rounded-full hover:bg-gray-100">
